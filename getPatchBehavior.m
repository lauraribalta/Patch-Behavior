...
% Calculating trial onset and chosen report
...
for i = 2:size(all_On, 1)
    ...
    pre_port_on = all_On(i - 1, 2);     % Next port    
...
behavTrials.ports_probability = zeros(size(start_trial,1),7); % probabilities of all ports
behavTrials.patch_number = zeros(size(start_trial,1),1); % number of patch switches
